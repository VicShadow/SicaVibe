...
INSERT INTO Utilizador (HotelID, Email, Password, Nome, DataNascimento, NTelemovel, Morada, Cc, Nif, Estado, Discriminator)
VALUES (null, 'hospede@example.com', 'hospede', 'John Doe'     , '1990-01-01', '123456789', 'John Street nº5'  ,  '123123123', '111111111', null   , 'Hospede'),
       (null, 'jane@example.com'   , 'jane'   , 'Jane Smith'   , '1995-05-10', '987654321', 'Jane Street nº30' ,  '321321321', '222222222', null   , 'Administrador'),
       (1   , 'alice@example.com'  , 'alice'  , 'Alice Johnson', '1988-12-25', '111111111', 'Alice Street nº10',  '456456456', '333333333', 'ATIVO', 'Funcionario');
