...
CREATE TABLE Utilizador (ID int(10) NOT NULL AUTO_INCREMENT, HotelID int(10), Email varchar(255) UNIQUE, Password varchar(255), Nome varchar(255), DataNascimento date, NTelemovel varchar(255), Morada varchar(255), Cc varchar(255) UNIQUE, Nif varchar(255) UNIQUE, Estado ENUM('ATIVO','INATIVO','EM_PAUSA'), Discriminator varchar(255) NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
