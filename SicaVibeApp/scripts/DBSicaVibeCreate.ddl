...
USE SicaVibe;
CREATE TABLE Hotel (ID int(10) NOT NULL AUTO_INCREMENT, Nome varchar(255), Descricao varchar(255), Img mediumblob, Endereco varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Hospede (ID int(10) NOT NULL AUTO_INCREMENT, Email varchar(255), Password varchar(255), Nome varchar(255), DataNascimento date, Morada varchar(255), NTelemovel varchar(255), Cc varchar(255), Nif varchar(255), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE TipoDeQuarto (ID int(10) NOT NULL AUTO_INCREMENT, Nome varchar(255), Capacidade int(10), Preco float, Descricao varchar(255), Img mediumblob, PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
...
CREATE TABLE Reserva (ID int(10) NOT NULL AUTO_INCREMENT, HospedeID int(10) NOT NULL, HotelID int(10) NOT NULL, DataEntrada date, DataSaida date, DataCheckIn date, DataCheckout date, Preco float, PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
CREATE TABLE Funcionario (ID int(10) NOT NULL AUTO_INCREMENT, HotelID int(10) NOT NULL, Email varchar(255), Password varchar(255), Nome varchar(255), DataNascimento date, Morada varchar(255), NTelemovel varchar(255), Estado ENUM('ATIVO','INATIVO','EM_PAUSA'), PRIMARY KEY (ID)) ENGINE=InnoDB CHARACTER SET UTF8;
...
CREATE TABLE Hotel_TipoDeQuarto (HotelID int(10) NOT NULL, TipoDeQuartoID int(10) NOT NULL, PRIMARY KEY (HotelID, TipoDeQuartoID)) ENGINE=InnoDB CHARACTER SET UTF8;
